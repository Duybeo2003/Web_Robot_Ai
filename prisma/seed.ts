...
async function main() {
    ...
    data: [
      {
        ...
        description:
          "Robot giáo dục mBot Neo với khả năng kết nối mạng, AI, IoT. Lập trình qua Scratch và Python, phù hợp cho học sinh từ 8 tuổi.",
        price: 3490000,
        type: "ROBOT_STEM",
        sku: "MBOT-NEO-01",
        inventoryCount: 50,
        imageUrl:
          "https://images.unsplash.com/photo-1535378273068-9bb67d5beacd?q=80&w=800&auto=format&fit=crop",
      ...
      },
      {
        ...
        description:
          "Chó robot điện tử thông minh có thể nhận diện khuôn mặt, nghe lời và tương tác. Hỗ trợ học lập trình cơ bản.",
        price: 4990000,
        type: "ROBOT_STEM",
        sku: "ROBODOG-AI-02",
        inventoryCount: 20,
  ...
  await prisma.product.create({
    data: {
      ...
      description:
        "Bộ kit cơ bản với hơn 200 linh kiện điện tử: mạch Arduino Uno R3, cảm biến siêu âm, động cơ servo, màn hình LCD và sách hướng dẫn chi tiết.",
      price: 650000,
      type: "KIT_ARDUINO",
      sku: "ARDUINO-KIT-01",
      inventoryCount: 150,
      imageUrl:
        "https://images.unsplash.com/photo-1517077304055-6e89aadf0c84?q=80&w=800&auto=format&fit=crop",
  ...
  await prisma.product.create({
    data: {
      ...
      description:
        "Học nguyên lý truyền động bánh răng thông qua trò chơi lắp ráp gỗ 3D tự động. An toàn, kích thích tư duy kỹ thuật.",
      price: 250000,
      type: "DO_CHOI_LOGIC",
      sku: "LOGIC-GEARS-01",
      inventoryCount: 300,
      imageUrl:
        "https://images.unsplash.com/photo-1558066524-7389a4437435?q=80&w=800&auto=format&fit=crop",
