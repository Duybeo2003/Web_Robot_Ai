...
const getOrderStatusBadge = (status: string) => {
  switch (status) {
    ...
    case "COMPLETED":
      return (
        <Badge className="bg-green-100 text-green-800 hover:bg-green-200 shadow-none border-transparent">
          Đã giao thành công
        </Badge>
      );
    case "CANCELLED":
                  ...
                  >
                    ...
                    <TableCell>
                      {order.paymentStatus === "PAID" ? (
                        <Badge className="bg-emerald-100 text-emerald-700 hover:bg-emerald-200 shadow-none border-transparent">
                          Đã thanh toán
                        </Badge>
                      ) : (
                        <Badge
                          variant="secondary"
                          className="bg-stone-100 text-stone-600 hover:bg-stone-200 border-transparent"
                        >
                          Chưa thanh toán
                        </Badge>
                      )}
