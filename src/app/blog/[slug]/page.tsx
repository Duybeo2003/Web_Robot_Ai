...
export async function generateMetadata({
  ...
  const title = `${article.title} - Blog RoboEQ`;
    ...
    <div className="bg-background min-h-screen pb-20">
      ...
      <div className="bg-white border-b border-border py-12 md:py-16">
        <div className="container mx-auto px-4 max-w-4xl">
          <Link
            href="/blog"
            className="inline-flex items-center text-sm text-primary hover:underline mb-8 font-medium"
          >
          ...
          <div className="flex flex-wrap items-center gap-6 text-sm text-muted-foreground">
            <div className="flex items-center gap-2">
              ...
              <span className="font-medium text-foreground">
                {article.author?.name || "RoboEQ Team"}
              </span>
            </div>
        ...
        <div className="mt-16 pt-8 border-t border-border flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <div className="flex gap-2">
              <button className="w-8 h-8 rounded-full bg-[#1877F2] text-white flex items-center justify-center hover:opacity-90 font-bold">
                f
              </button>
            </div>
          </div>
