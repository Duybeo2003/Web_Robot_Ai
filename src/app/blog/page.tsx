...
export const metadata = {
  title: "Blog & Kiến Thức STEM - RoboEQ",
  description:
    "Cập nhật những kiến thức mới nhất về giáo dục STEM, lập trình Robot và tư duy logic cho trẻ.",
};
    ...
    <div className="container mx-auto px-4 py-12 min-h-screen bg-background">
      <div className="mb-12 text-center max-w-2xl mx-auto">
        ...
        <p className="text-muted-foreground text-lg">
          Những bài viết, hướng dẫn và kiến thức bổ ích giúp con bạn làm quen
          với công nghệ và tư duy lập trình từ sớm.
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {articles.map((article) => (
            <Link
              ...
              className="group flex flex-col bg-white rounded-xl overflow-hidden border border-border shadow-sm hover:shadow-md hover:border-primary/50 transition-all"
            >
              ...
              <div className="p-6 flex flex-col flex-1">
                ...
                <div className="flex items-center justify-between text-xs text-muted-foreground mt-auto pt-4 border-t border-border">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span>{article.author?.name || "RoboEQ Team"}</span>
                  </div>
                  <div className="flex items-center gap-1.5">
