export const metadata = {
  ...
  description: "Chính sách bảo mật thông tin khách hàng tại RoboEQ.",
};
  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-4xl bg-white my-8 rounded-sm shadow-sm border border-neutral-100">
      ...
      <div className="prose prose-neutral max-w-none space-y-6 text-neutral-700 leading-relaxed">
        <p>
          Cám ơn quý khách đã truy cập vào website của RoboEQ. Chúng tôi tôn
        ...
        <p>
          Chúng tôi sẽ thu thập nhiều thông tin khác nhau của bạn khi bạn muốn
          đặt hàng trên web. Việc thu thập dữ liệu chủ yếu trên website bao gồm:
          email, điện thoại, tên đăng nhập, mật khẩu đăng nhập, địa chỉ khách
          hàng. Đây là các thông tin mà chúng tôi cần thành viên cung cấp bắt
          buộc khi đăng ký sử dụng dịch vụ và để liên hệ xác nhận khi khách hàng
          đăng ký sử dụng dịch vụ trên website nhằm đảm bảo quyền lợi cho người
          tiêu dùng.
        </p>
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>
            Ngừa các hoạt động phá hủy tài khoản người dùng của người dùng hoặc
            các hoạt động giả mạo người dùng.
          </li>
          <li>
            Liên lạc và giải quyết với người dùng trong những trường hợp đặc
            biệt.
          </li>
        </ul>
        ...
        <p>
          Thông tin cá nhân của người dùng trên RoboEQ được cam kết bảo mật
          tuyệt đối theo chính sách bảo vệ thông tin cá nhân của công ty. Việc
          thu thập và sử dụng thông tin của mỗi người dùng chỉ được thực hiện
