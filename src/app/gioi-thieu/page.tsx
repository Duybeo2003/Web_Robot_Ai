export const metadata = {
  ...
  description:
    "Tìm hiểu về RoboEd - Nền tảng cung cấp đồ chơi giáo dục STEM hàng đầu.",
};
  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-4xl bg-white my-8 rounded-sm shadow-sm border border-neutral-100">
      ...
      <div className="prose prose-neutral max-w-none space-y-6 text-neutral-700 leading-relaxed">
        <p>
          Chào mừng bạn đến với <strong>RoboEd (Robot Thông Minh)</strong> - Nền
        ...
        <p>
          ...
          nghệ&quot;, RoboEd cam kết mang đến cho trẻ em và học sinh sinh viên những
