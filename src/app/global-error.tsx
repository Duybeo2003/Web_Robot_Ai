    ...
    <html lang="vi">
      <body className="flex min-h-screen items-center justify-center bg-neutral-50 px-4 font-sans text-neutral-900">
        <main className="w-full max-w-xl rounded-2xl border border-neutral-200 bg-white p-6 text-center shadow-sm sm:p-10" role="alert">
          ...
          <p className="mb-2 text-sm font-bold uppercase tracking-[0.2em] text-[#FF5722]">RoboEQ</p>
          ...
          <div className="mt-7 flex flex-col justify-center gap-3 sm:flex-row">
            <button
              type="button"
              className="min-h-11 rounded-lg bg-[#FF5722] px-6 font-semibold text-white transition-colors hover:bg-[#E64A19] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FF5722]/40"
              onClick={reset}
            >
              Thử lại
            </button>
            <Link
              href="/"
              className="inline-flex min-h-11 items-center justify-center rounded-lg border border-neutral-300 bg-white px-6 font-semibold text-neutral-800 transition-colors hover:bg-neutral-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FF5722]/30"
            >
              Về trang chủ
            </Link>
          </div>
