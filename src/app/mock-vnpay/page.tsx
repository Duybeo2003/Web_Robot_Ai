    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center items-center p-4 font-sans">
      <div className="max-w-md w-full bg-white rounded-xl shadow-2xl overflow-hidden border border-gray-100">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-800 p-6 text-white text-center relative overflow-hidden">
          ...
          <h1 className="text-2xl font-black tracking-wider relative z-10">
            VNPAY SANDBOX
          </h1>
          <p className="text-blue-100 mt-1 text-sm font-medium relative z-10">
            Môi trường thử nghiệm giả lập (Mock)
          </p>
        </div>
        ...
        <div className="p-6">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-8">
            <p className="text-xs text-yellow-800 text-center leading-relaxed">
              <strong>Lưu ý:</strong> Đây là trang thanh toán giả lập được tạo
              ra bởi AI vì bạn chưa cấu hình thông tin VNPAY thật. Bạn có thể
              chọn Thanh toán thành công hoặc Hủy để test luồng.
            </p>
          </div>
