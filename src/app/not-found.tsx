  ...
  return (
    <main className="flex min-h-[65vh] items-center justify-center bg-neutral-50 px-4 py-16 text-center">
      <div className="max-w-lg">
        <p className="mb-3 text-sm font-bold uppercase tracking-[0.25em] text-primary">Lỗi 404</p>
        ...
        <div className="flex flex-col justify-center gap-3 sm:flex-row">
          <Link className="rounded-lg bg-primary px-6 py-3 font-semibold text-primary-foreground hover:bg-primary/90" href="/">
            Về trang chủ
          </Link>
