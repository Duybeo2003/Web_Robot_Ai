            ...
            {product.type === "ROBOT_STEM" && (
              <div className="mt-8 rounded-xl border border-neutral-100 bg-neutral-50 p-5 sm:p-6">
                ...
                <ul className="list-disc pl-5 space-y-2">
                  ...
                  <li>
                    Tương tác thực tế, giảm thời gian sử dụng màn hình vô ích.
                  </li>
                </ul>
              </div>
            )}
            ...
            <table className="w-full min-w-[480px] border-collapse text-left text-sm">
              <tbody>
                <tr className="border-b border-neutral-100">
                  ...
                  <td className="py-3 px-4">RoboEQ</td>
                </tr>
                <tr className="border-b border-neutral-100">
                  <td className="py-3 px-4 bg-neutral-50 font-medium border-r border-neutral-100">
                    Danh mục
                  </td>
                  <td className="py-3 px-4">
                    {product.category?.name || "Đồ chơi Giáo dục"}
                  </td>
                </tr>
                <tr className="border-b border-neutral-100">
                  <td className="py-3 px-4 bg-neutral-50 font-medium border-r border-neutral-100">
                  ...
                  <td className="py-3 px-4">
                    {product.inventoryCount > 0
                      ? `Còn ${product.inventoryCount} sản phẩm`
                      : "Hết hàng"}
                  </td>
                </tr>
                ...
                {product.type === "KIT_ARDUINO" && (
                  <>
                    <tr className="border-b border-neutral-100">
                      ...
                      <td className="py-3 px-4">
                        ATmega328P (Tương thích Arduino Uno)
                      </td>
                    </tr>
                    <tr className="border-b border-neutral-100">
                      <td className="py-3 px-4 bg-neutral-50 font-medium border-r border-neutral-100">
                      ...
                      <td className="py-3 px-4">
                        5V DC (Khuyên dùng 7-12V từ nguồn ngoài)
                      </td>
                    </tr>
                  </>
                )}
                ...
                <div className="flex items-center gap-2 mt-2">
                  <div className="flex text-yellow-400">
                    {[1, 2, 3, 4, 5].map((star) => (
                      <Star
                        key={star}
                        className={`w-5 h-5 ${star <= Number(avgRating) ? "fill-current" : "text-gray-300"}`}
                      />
                    ))}
                  </div>
                ...
                {reviews.length === 0 ? (
                  ...
                  reviews.map((review: any) => (
                    ...
                    >
                      ...
                      <p className="text-sm text-neutral-600 pl-8">
                        {review.comment}
                      </p>
                    </div>
                  ))
