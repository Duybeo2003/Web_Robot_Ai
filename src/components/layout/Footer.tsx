        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div className="space-y-4">
            ...
            <div className="flex gap-4 pt-2">
              {business.socialLinks.facebook && <Link
              ...
              {business.socialLinks.shopee && <Link
                href={business.socialLinks.shopee}
                target="_blank"
                rel="noopener noreferrer"
              ...
              {business.socialLinks.zalo && <Link
                href={business.socialLinks.zalo}
                target="_blank"
                rel="noopener noreferrer"
